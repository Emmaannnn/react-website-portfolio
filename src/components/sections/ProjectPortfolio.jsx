...
export const WebsitePortfolio = () => {
  ...
  {
    id : 1,
    imgLogo : BatoBatoPickImg,
    imgLogo2 : BatoBatoPickGamePlay,
    imgLogo3 : BatoBatoPickGamePlay2,
    systemType : 'Web-Based:',
    name : 'BatoBatoPick Game',
    liveStatus : 'Available',
    projectDescription : 'Enjoy a fun Bato Bato Pick game where you challenge your luck with rock, paper, or scissors! Play single player now — PvP mode coming soon!',
    link : 'https://emmaannnn.github.io/Rock-Paper-Scissors/',
    isLive : true,
  },
  
  {
    id : 2,
    imgLogo : UnavailableImg,
    imgLogo2 : UnavailableImg,
    imgLogo3 : UnavailableImg,
    systemType : 'No title',
    name : '',
    ...
    <div className="md:py-20 py-10 border-b border-black/15">
      ...
      <div className="flex flex-col gap-6">
        {webProject.map (project => (
          <div key={project.id} className="bg-primary rounded-2xl shadow-md border border-slate-200 p-4 hover:shadow-lg hover:scale-105 transition-all duration-300 mx-5 md:mx-40">
            <div className="flex flex-col md:grid md:grid-cols-12 gap-4 md:gap-8">
              <div className="md:col-span-5 flex justify-center">
                <div className="hover-gallery w-full">
                  <img src={project.imgLogo} alt="BatoBatoPick Logo" className="w-auto h-60 rounded-xl object-cover"/>
                  <img src={project.imgLogo2} alt="BatoBatoPickGamePlay" className="w-full h-60 rounded-xl object-cover"/>
                  <img src={project.imgLogo3} alt="BatoBatoPickGamePlay2" className="w-full h-60 rounded-xl object-cover"/>
                </div>              
              </div>

              <div className="md:col-span-7 mt-4 Inter flex flex-col justify-between">
                <div className="title">
                  <h1 className="text-2xl font-bold mb-1 text-[black]/80">{project.systemType} <span className="text-secondary">{project.name}</span></h1>
                  
                  {project.liveStatus === 'Available' ? (
                      <div className="badge badge-sm badge-outline badge-success italic">{project.liveStatus}</div>
                    ) : (
                      <div className="badge badge-sm badge-outline badge-error italic">{project.liveStatus}</div>
                    )
                  }
                ...
                {project.isLive === true ? (
                  ...
                  <button className="btn w-full" disabled>Live Demo <svg className="pl-1 h-4 w-4 cursor-pointer" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 256 256" height="256px" id="Layer_1" version="1.1" viewBox="0 0 256 256" width="256px" xml:space="preserve"><path d="M164.525,222.138l89.6-89.6c2.5-2.5,2.5-6.551,0-9.051l-89.6-89.6c-2.5-2.5-6.551-2.5-9.051,0s-2.5,6.743,0,9.243  L234.15,122H6.4c-3.535,0-6.4,2.466-6.4,6s2.865,6,6.4,6h227.75l-78.676,78.881c-1.25,1.25-1.875,2.992-1.875,4.629  s0.625,3.326,1.875,4.576C157.975,224.586,162.025,224.638,164.525,222.138z"></path></svg></button>
                )}
