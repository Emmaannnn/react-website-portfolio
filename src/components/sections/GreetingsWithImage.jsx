...
const GreetingsWithImage = () => {
  ...
  return (
    <div className="grid grid-cols-12 gap-auto bg-primary mt-14 md:mt-6 min-h-[640px] md:border-b border-black/15">
        <div className="col-span-12 md:col-span-7 z-6 flex flex-col text-center md:text-start mt-15 md:mt-55 px-4 md:pl-20 text-third">
            ...
            <p className="Varela text-sm md:text-lg md:mb-6 md:mr-12 text-black/70 ">Aspiring Web Developer and Graphic Designer passionate about developing designs that are both beautiful and functional.</p>
